...
// Check functions
bool check_vd(PyObject * input){
  // std::cout << "Check if it is a double array...\n";
  bool res=
    (PyArray_CheckExact(input) &&
     (PyArray_TYPE((PyArrayObject*) input)==NPY_DOUBLE) &&
     (PyArray_NDIM((PyArrayObject*) input)==1))?true:false;
  // if(res){
  //   std::cout << "Is is a double array.\n";
  //   }
    return res;
  }
  bool check_vc(PyObject * input){
    // std::cout << "Check if it is a complex array..\n";
    bool res=(PyArray_CheckExact(input) &&
	      (PyArray_TYPE((PyArrayObject*) input)==NPY_COMPLEX128) &&
	      (PyArray_NDIM((PyArrayObject*) input)==1))?true:false;
    // if(res){
    //   std::cout << "Is is a complex array..\n";
    // }
    return res;
  }

  bool check_vd2(PyObject * input){
    // std::cout << "Check if it is a double array of size 2...\n";
    bool res=(PyArray_CheckExact(input) &&
	(PyArray_TYPE((PyArrayObject*) input)==NPY_DOUBLE) &&
    ...
    // if(res){
    //   std::cout << "Is is a double array of size 2..\n";
    // }
    return res;
  }
  bool check_vc2(PyObject * input){
    // std::cout << "Check if it is a complex array of size 2...\n";
    bool res=(PyArray_CheckExact(input) &&
	      (PyArray_TYPE((PyArrayObject*) input)==NPY_COMPLEX128) &&
	      (PyArray_NDIM((PyArrayObject*) input)==1) &&
	      (PyArray_DIMS((PyArrayObject*) input)[0]==2)
  ...
  bool check_vd4(PyObject * input){
    cout << "Not yet implemented!\n";
    return false;
  }
  bool check_vc4(PyObject * input){
    cout << "Not yet implemented!\n";
    return false;
  }
  ...
  bool check_cmat22(PyObject * input){
    cout << "Not yet implemented!\n";
    return false;
  }
